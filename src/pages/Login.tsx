...
export default function Login({
  ...
  return <div className="min-h-screen bg-gradient-to-br from-background via-background-secondary to-background-tertiary flex items-center justify-center p-6">
      <div className="w-full max-w-md space-y-8">
        {/* Header with Logo */}
        <div className="text-center space-y-4">
          {/* OneOrigin Logo */}
          <div className="flex justify-center mb-6">
            <img src={theme === 'dark' ? '/lovable-uploads/dd643953-77fa-4e55-a10d-1a0df298ef50.png' : '/lovable-uploads/6769a209-c508-4221-a988-13dc68d43d9f.png'} alt="OneOrigin" className="h-8 w-auto object-contain opacity-90" onError={e => {
        ...
        <GlassCard className="p-8 space-y-6">
          {/* Google Login Button */}
          <Button onClick={handleGoogleLogin} variant="outline" className="w-full h-12 text-base font-medium border-border/60 hover:bg-accent hover:text-accent-foreground">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="Enter your email" className="pl-10 h-12 bg-background/50 border-border/60 focus:border-primary/50" required />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input type={showPassword ? "text" : "password"} value={password} onChange={e => setPassword(e.target.value)} placeholder="Enter your password" className="pl-10 pr-10 h-12 bg-background/50 border-border/60 focus:border-primary/50" required />
            ...
            {/* Submit Button */}
            <Button type="submit" className="w-full h-12 bg-primary hover:bg-primary/90 text-primary-foreground text-base font-medium" disabled={isLoading}>
